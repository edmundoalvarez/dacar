            ...
            <div className="pb-8 px-16 bg-gray-100 min-h-screen">
                <div className="flex gap-4 justify-between items-center mb-8 bg-gray-800 p-8 rounded-bl-2xl rounded-br-2xl border-b-2 border-b-emerald-500 border-l-2 border-l-emerald-500 border-r-2 border-r-emerald-500 shadow-sm">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            className="bg-emerald-600 hover:bg-emerald-500 text-white font-semibold py-1 px-4 rounded-lg shadow-md transition duration-200 flex flex-row justify-center items-center gap-2"
                        ...
                        >
                            <img
                                ...
                                className="w-[20px]"
                            />
                            <p className="m-0 leading-loose">Agregar pieza</p>
                        </button>
                    </div>
                </div>
                {/* crear pieza */}
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="flex gap-6 w-1/4">
                                <button
                                    className="bg-emerald-600 hover:bg-emerald-500 text-white font-medium py-2 px-6 rounded-lg shadow-md mt-0 mb-4 transition duration-200 w-full"
                                    type="submit"
                                >
                                    Agregar pieza
                                </button>
                                <button
                                    className="border-2 border-emerald-600 hover:border-emerald-500 text-emerald-600 font-medium py-2 px-6 rounded-lg shadow-md mt-0 mb-4 transition duration-200 w-full"
