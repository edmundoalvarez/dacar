    ...
    const getBudgetToSet = () => {
        getBudgetById(budgetId)
            .then((budgetData) => {
                ...
                setTotalLacqueredAll(
                    Number(budgetData.data.lacquered[0].lacqueredM2)
                );
                ...
                setTotalLacqueredEdgeLength(
                    Number(
                        budgetData.data.edge_lacquered[0]
                ...
                setTotalPolishedEdgeLength(
                    Number(
                        budgetData.data.edge_polished[0].totalPolishedEdgeLength
                    )
                );
                setValue(
                ...
                //FILO SIN NADA
                setTotalEdgeLength(
                    Number(budgetData.data.edge_no_lacquered[0].edgeM2)
                );
                setValue(
                    "edgeSelect",
                    budgetData.data.edge_no_lacquered[0].edgeSelect
                );
                ...
                if (budgetData.data.materials) {
                    if (budgetData.data.materials.length > 0) {
                        ...
                        const totalMaterialPrice =
                            budgetData.data.materials.reduce(
                                (acc, material) => {
                ...
                if (budgetData.data.extra_items) {
                    if (budgetData.data.extra_items.length > 0) {
                        budgetData.data.extra_items.forEach(
                            (extraItem, index) => {
                                // Asignar el valor de materialTable
                                setValue(
                                    `itemExtra${index}`,
                                ...
                                setCountItemExtra(
                                    budgetData.data.extra_items.length
                                );
                            }
                        );
                    }
                ...
                if (budgetData.data?.chapa) {
                    if (budgetData.data.extra_items.length > 0) {
                        budgetData.data.chapa.forEach((chapaItem, index) => {
                            ...
                            setValue(
                                "veneerSelect",
                                chapaItem.veneerSelect || ""
                            );
                            setValue(
                                "chapa_price",
                                chapaItem.chapa_price || ""
                            );
                ...
                setValue(
                    "adjustment_reason",
                    budgetData.data.adjustment_reason || ""
                );
                setValue(
                    "adjustment_price",
                    budgetData.data.adjustment_price || ""
                );
                ...
                if (budgetData.data.placement) {
                    ...
                    setValue(
                        "placementDays",
                        budgetData.data.placement_days || ""
                    );
                    setValue(
                        "placementPrice",
                        budgetData.data.placement_price || ""
                    );
                ...
                if (budgetData.data.shipment) {
                    ...
                    setValue(
                        "shipmentPrice",
                        budgetData.data.shipment_price || ""
                    );
                } else {
                                ...
                                {totalVeneerPolished > 0 ? (
                                    <>
                                        <p className="mb-1">
                                            ...
                                            {totalVeneerPolished} m<sup>2</sup>{" "}
                                            Precio:
                                            {formatCurrency(
                                                lustreService?.price *
                                                    totalVeneerPolished
